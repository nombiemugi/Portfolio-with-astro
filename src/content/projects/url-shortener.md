...
Develop an application that allows you to shorten the URLs of the link you place. I did it using the free TinyURL API to shorten the URLs. Additionally, you can automatically copy it to the clipboard by pressing the button next to the shortened version.
